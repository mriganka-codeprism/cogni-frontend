  ...
  const transformedUsers = React.useMemo(
    () =>
      allUsers?.data?.map((item: any) => {
        const educationEntry = item.college_name;
        const educationText = educationEntry ? educationEntry : "N/A";
  ...
  return (
    <>
                    ...
                    {loading && transformedUsers.length === 0
                      ...
                      : displayedUsers.map((item) => (
                        ...
                        >
                          ...
                          >
                            <Tooltip title={item.college} placement="top" arrow>
                          ...
                          >
                            <span>
                              <CustomButton
                                ...
                                additionalStyles={{
                                  ...adminHomeStyles.button,
                                  borderColor: item.violationCount > 0 ? "#B45309" : "#D1D5DB",
                                  color: item.violationCount > 0 ? "#B45309" : "#D1D5DB",
                                }}
                              >
      ...
      <ProctoringViolationsModal
        ...
        onClose={() =>
          setViolationsDialog({ open: false, conversationId: "", candidateName: "" })
        }
